...
def main():
	...
	st.set_page_config(page_title="SURVIVE BRO")
	overview = st.container()
	left, right = st.columns(2)
	prediction = st.container()

	st.image("https://services.meteored.com/img/article/titanic-10-curiosidades-sobre-el-naufragio-mas-famoso-de-la-historia-1681429632845_1280.jpg")
	...
	with prediction:
		st.subheader("Czy taka osoba przeży łaby katastrofę?")
		st.subheader(("Tak" if survival[0] == 1 else "Nie"))
		st.info("Pewność predykcji {0:.2f} %".format(s_confidence[0][survival][0] * 100))
